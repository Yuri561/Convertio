...
const MP4toMP3 = () => {
  ...
  useEffect(() => {
    const loadFFmpeg = async () => {
      const { createFFmpeg, fetchFile } = await import('https://cdn.jsdelivr.net/npm/@ffmpeg/ffmpeg@0.9.8');
  ...
  return (
    <div className="mp4-to-mp3-converter-container p-6 bg-gray-100 min-h-screen">
      <h1 className="text-4xl font-extrabold mb-4 text-orange-500">MP4 to MP3 Converter</h1>
      <p className="text-lg mb-8 text-gray-700">Drag and drop your MP4 videos here to convert them to MP3 audio.</p>
      ...
      <div className="files-grid mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {files.map((file, index) => (
          <div key={index} className="file-item p-4 bg-white rounded-lg shadow-md flex items-center space-x-4">
