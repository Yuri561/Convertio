...
const WordConverter = () => {
  ...
  return (
    <div className="word-converter-container p-6 bg-gray-100 min-h-screen">
      <h1 className="text-4xl font-extrabold mb-4 text-orange-500">Word Converter</h1>
      <p className="text-lg mb-8 text-gray-700">Drag and drop your documents here to convert them to Word format.</p>
