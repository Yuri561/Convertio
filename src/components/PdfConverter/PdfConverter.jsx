...
const PdfConverter = () => {
  ...
  return (
    <div className="pdf-converter-container p-6 bg-gray-100 min-h-screen">
      <h1 className="text-4xl font-extrabold mb-4 text-orange-500">PDF Converter</h1>
      <p className="text-lg mb-8 text-gray-700">Drag and drop your documents here to convert them to PDF.</p>
      ...
      {pdfUrl && (
        <div className="mt-8">
          <a href={pdfUrl} download="converted.pdf" className="text-blue-500">
            Download PDF
          </a>
        </div>
      )}
